...
function Sectionone() {
  return (
    <section id="banner" className="relative">
      ...
      {/* Div do Texto */}
      <div
        className="absolute top-0 left-0 w-1/2 h-full p-4 pt-10 pl-8 text-white"
      ...
      >
        ...
        <p className="pt-4 text-base font-bold text-white">
          Somos uma empresa de tecnologia especializada em criar soluções de
          software que <br /> simplificam e geram mais valor a diversos
          segmentos importantes para a sociedade.
        </p>
      </div>
    </section>
  );
